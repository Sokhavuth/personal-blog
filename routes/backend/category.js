...
categoryRouter.get('/edit/:id',login.authAdmin,async function(req,res){
    if(req.userRole){
...
categoryRouter.post('/edit/:id',login.authAdmin,async function(req,res){
    if(req.userRole){
...
categoryRouter.get('/delete/:id',login.authAdmin,async function(req,res){
    if(req.userRole){
