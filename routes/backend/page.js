...
pageRouter.get('/edit/:id',login.authAdmin ,async function(req,res){
    if(req.userRole){
        await page.getPage(req,res)
    }else{
        res.redirect("/admin/page")
...
pageRouter.post('/edit/:id',login.authAdmin ,async function(req,res){
    if(req.userRole){
...
pageRouter.get('/delete/:id',login.authAdmin,async function(req,res){
    if(req.userRole){
