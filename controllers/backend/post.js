...
class Post{
    async getPage(req,res){
        ...
        const posts = await postDb.getPosts(req, req.settings.dItemLimit)
        req.settings.items = posts
        req.settings.count = await postDb.count(req)
    ...
    async paginatePosts(req, res){
        const posts = await postDb.paginatePosts(req, req.settings.dItemLimit)
        req.settings.items = posts
        req.settings.type = "post"
