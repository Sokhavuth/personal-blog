...
class User{
    async getPage(req, res){
        ...
        const users = await userDb.getUsers(req, req.settings.dItemLimit)
        req.settings.items = users
        req.settings.count = await userDb.count(req)
    ...
    async paginateUsers(req, res){
        const users = await userDb.paginateUsers(req, req.settings.dItemLimit)
        req.settings.items = users
        req.settings.type = "user"
